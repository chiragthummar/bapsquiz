 ...
 */
public class CustomBookAdapter  extends BaseAdapter implements View.OnTouchListener{
    ...
    public CustomBookAdapter(Context context, List<Book> bookList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mTextView.setText(bookList.get(position).getName());
...
//download and display image from url
        imageLoader.displayImage(bookList.get(position).getPhoto(), mImageView, options);
